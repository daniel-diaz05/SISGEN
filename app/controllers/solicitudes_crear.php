<?php
/**
 * Endpoint: /app/controllers/solicitudes_crear.php
 * Método: POST
...
// solicitante tomado desde la sesión (no desde localStorage)
$solicitante = $_SESSION['usuario_email'] ?? $_SESSION['usuario_nombre'] ?? 'desconocido';
...
try {
    ...
    // Insertar items
    $stmt2 = $conn->prepare(
        "INSERT INTO solicitud_items (solicitud_id, producto_id, cantidad) VALUES (?,?,?)"
    );
